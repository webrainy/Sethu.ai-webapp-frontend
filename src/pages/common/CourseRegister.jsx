...
function CourseRegister() {
  ...
  return (
    ...
    >
      <div className="w-auto max-w-4xl max-h-[80] shadow-2xl flex flex-col items-center justify-center py-8 pb-3 px-3 bg-white">
        <div className="w-72 lg:w-96 mb-5 text-center">
          <p className="font-bold text-xl sm:text-xl text-gray-500 uppercase">
            Python Data Engineer{" "}
            <span className="font-bold text-xl sm:text-xl text-black uppercase">
              {" "}
              Training
            </span>
          </p>
