...
function StudentProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    form_data.append("sk_python", formData.sk_python);
    form_data.append("sk_sql", formData.sk_sql);
    form_data.append("sk_java", formData.sk_java);
    form_data.append("sk_analyticalskill", formData.sk_analyticalskill);
    form_data.append("sk_prblmsolving", formData.sk_prblmsolving);
    form_data.append("sk_engprof", formData.sk_engprof);
    form_data.append("hckr_rnk", formData.hckr_rnk);
    ...
    const result = await dispatch(
      updateStudentData({
        end_point: `/api/student/edit`,
        access_token: access_token,
        student_data: form_data,
      })
    ).unwrap();
              ...
              <div className="mt-5 grid lg:grid-cols-2 gap-4">
                  ...
                  {[
                    ...
                    <div key={skill.name} className="text-left">
                      ...
                      <Select
                        ...
                        onChange={(value) =>
                          handleInputChange(value, skill.name)
                        }
                        required
                      >
                ...
                <div className="shadow-md bg-white p-4 rounded-xl flex flex-col gap-3 h-fit">
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleInputChange(e.target.value, "incomev")
                    }
                  >
                    {[
                      "Less than 5 Lakhs",
